...
(
    ...
    external_id  VARCHAR(50) NOT NULL        DEFAULT 'mfa_' || replace(uuid_generate_v4()::VARCHAR, '-', ''),
    description  VARCHAR(200),
    method_type  VARCHAR(50) NOT NULL, -- 'totp', 'sms', 'backup_code'
    otp_key      VARCHAR(200),
...
insert into user_mfa_method (user_id, method_type, otp_key, is_active, created_at, updated_at)
