...
public class ComparatorsTest {
    ...
    public void shouldOrderGatewayAccountsIdsNumericFirst() {
        List<String> result = Stream.of("aaa","1", "6", "cde", "4", "bbb23", "10", "5").sorted(Comparators.compareGatewayAccounts()).collect(Collectors.toList());
        assertThat(result, is(Arrays.asList("1","4","5","6","10","aaa","bbb23","cde")));
    }
