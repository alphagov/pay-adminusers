...
public class InviteUserRequestValidatorTest {
    ...
    public void shouldSuccess_ifAllFieldsArePresentAndValidEmailDomain() {
        ImmutableMap<String, String> payload = ImmutableMap.of("email", "example@example.gov.uk", "telephone_number", "02079304433", "password", "super-secure-password");
    ...
    public void shouldFail_ifMissingRequiredField() {
        ImmutableMap<String, String> payload = ImmutableMap.of( "telephone_number", "02079304433", "password", "super-secure-password");
        JsonNode payloadNode = objectMapper.valueToTree(payload);
        Optional<Errors> errors = validator.validateCreateServiceRequest(payloadNode);
    ...
    public void shouldFail_ifInvalidEmailFormat() {
        ImmutableMap<String, String> payload = ImmutableMap.of( "email", "exampleatexample.com", "telephone_number", "02079304433", "password", "super-secure-password");
        JsonNode payloadNode = objectMapper.valueToTree(payload);
        Optional<Errors> errors = validator.validateCreateServiceRequest(payloadNode);
    ...
    public void shouldFail_ifEmailAddressNotPublicSector() {
        ImmutableMap<String, String> payload = ImmutableMap.of( "email", "example@example.com","telephone_number", "02079304433", "password", "super-secure-password");
        JsonNode payloadNode = objectMapper.valueToTree(payload);
